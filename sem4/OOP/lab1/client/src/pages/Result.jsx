          ...
          <div className='flex flex-col sm:grid grid-cols-2 gap-8 '>
           ...
           {/* BUTTONS */}
            <div className='flex justify-center sm:justify-end items-center flex-wrap mt-8 gap-4'>
              <button className='px-8 py-2.5 text-violet-600 text-sm border border-violet-600 rounded-full hover:scale-105 transition-all duration-500'>Try another image</button>
              <a className='px-8 py-2.5 bg-gradient-to-tr from-violet-700 to-fuchsia-500 text-white rounded-full hover:scale-105 transition-all duration-500'href="">Download image</a>
            </div>
      </div>
    </div>
  )
