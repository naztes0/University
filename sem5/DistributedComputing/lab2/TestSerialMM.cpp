                              ...
                              int Size)
{
    ...
    for (i = 0; i < Size; i++)
        for (j = 0; j < Size; j++)
        {
            pAMatrix[i * Size + j] = rand() / double(1000000000);
            pBMatrix[i * Size + j] = rand() / double(1000000000);
        }
}
...
int main()
{
    ...
    int sizeArr[] = {10, 100, 500, 1000, 1500, 2000, 2500, 3000};

    printf("Serial matrix multiplication program\n");
    for (int i = 0; i < 8; i++)
    {
        Size = sizeArr[i];
        printf("%s %d * %d", "Multiplication of matrices\n", sizeArr[i], sizeArr[i]);
